...
- Design proposals (`propose_design_requirement`, `propose_design_concept`, ADR-015) and experiment proposals (`propose_design_hypothesis`, `propose_experiment`, ADR-016) create PROPOSED records only; confirmation, selection, rejection, approval, observation and interpretation stay human.
