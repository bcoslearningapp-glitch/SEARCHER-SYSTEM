...
POLICIES: dict[str, ActionPolicy] = {
    ...
    for p in [
        ...
        # design hypotheses and experiments (PRD §33-34): AI may propose; running research on people is human
        _p("design_hypothesis.create", A.ACT_AND_NOTIFY),
        _p("design_hypothesis.revise", A.FORBIDDEN),
        _p("design_hypothesis.assess", A.FORBIDDEN, approval=True),
        _p("experiment.create", A.ACT_AND_NOTIFY),
        _p("experiment.protocol", A.FORBIDDEN),
        _p("experiment.transition", A.FORBIDDEN),
        _p("experiment.approve", A.FORBIDDEN, approval=True),
        _p("human_impact.assess", A.FORBIDDEN),
        ...
        _p("term.propose", A.ACT_AND_NOTIFY),
